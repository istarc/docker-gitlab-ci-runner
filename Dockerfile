...
RUN apt-key adv --keyserver keyserver.ubuntu.com --recv E1DF1F24 \
 ...
 && apt-key adv --keyserver keyserver.ubuntu.com --recv A3421AFB \
 && echo "deb http://ppa.launchpad.net/terry.guo/gcc-arm-embedded/ubuntu trusty main" >> /etc/apt/sources.list \
 && apt-get update \
